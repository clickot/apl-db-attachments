...
public class MainOverviewController {
    ...
    public DBConnection getDBConnection() {
        if (dbConn == null) {dbConn = DBConnection.getInstance(getConnectionString(), getUserName(), getPassword());}
        return dbConn;
    }
    ...
    private void handleConnect() {
        try {
            ...
            formMap = dbConn.getFormData(null);
    ...
    private void handleExecute() {
        ...
        try {
            recordList = getDBConnection().getAttachmentRecords(recordsQuery.getText(), form.getID(), form.getResolvedID(), form.getField(fieldComboBox.getValue()).getId(), formComboBox.getValue(), fieldComboBox.getValue());
        } catch (SQLException e) {
    ...
    private void handleFieldSelection() {
        recordsQuery.setText(dbConn.getAttachmentRecordQuery(formMap, formComboBox.getValue(), fieldComboBox.getValue(), null));
    }
