...
import static com.apl.Exporter.export;
...
public class MainOverviewController {
    ...
    private void saveFiles(boolean bulk) {
        ...
        String output = export(selectedItems, this.dbConn, bulk, selectedDirectory, this.formFolder, this.entryIDFolder, this.fieldNameFolder);
        if (!output.isEmpty()) {
