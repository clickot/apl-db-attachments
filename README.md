...
This is a plain refactoring of the Remedy Legacy Tool [DB Attachments](https://remedylegacy.com/tools/db-attachments/) to exchange old third party libraries, 
especially log4j 1.x. and Oracle JDK 1.8.
